...
// v9.82 — Cassidy Group Ltd lockup as crisp inline SVG (navy badge + two-tone gold
// heart + "CASSIDY GROUP LTD"). Vector, so it stays sharp at any size on a white
// background. A vector recreation of the brand mark — swap in the real artwork here
// if a high-res file becomes available.
var BRAND_LOGO_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 172" width="100%" height="100%" font-family="DM Sans, Arial, sans-serif">'
  + '<defs><clipPath id="lfLeftHalf"><rect x="0" y="0" width="110" height="120"/></clipPath></defs>'
  + '<rect x="76" y="4" width="68" height="68" rx="17" fill="#2E2F8A"/>'
  + '<path d="M110 60 C 92 46 82 39 82 30 C 82 24 87 20 92 20 C 97 20 110 28 110 33 C 110 28 123 20 128 20 C 133 20 138 24 138 30 C 138 39 128 46 110 60 Z" fill="#F5E4A0"/>'
  + '<path d="M110 60 C 92 46 82 39 82 30 C 82 24 87 20 92 20 C 97 20 110 28 110 33 C 110 28 123 20 128 20 C 133 20 138 24 138 30 C 138 39 128 46 110 60 Z" fill="#F1B93C" clip-path="url(#lfLeftHalf)"/>'
  + '<text x="110" y="120" text-anchor="middle" font-size="34" font-weight="800" letter-spacing="3" fill="#28286E">CASSIDY</text>'
  + '<line x1="60" y1="140" x2="160" y2="140" stroke="#C9A94A" stroke-width="1.5"/>'
  + '<text x="110" y="162" text-anchor="middle" font-size="15" font-weight="700" letter-spacing="7" fill="#2E2F8A">GROUP LTD</text>'
  + '</svg>';
